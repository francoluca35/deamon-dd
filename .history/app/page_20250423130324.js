...
export default function Home() {
  ...
  if (loading) {
    return (
      <div className="h-screen flex flex-col justify-center items-center bg-cover bg-center sm:bg-[url('/assets/background-mobile.png')] lg:bg-[url('/assets/background-desktop.png')]">
