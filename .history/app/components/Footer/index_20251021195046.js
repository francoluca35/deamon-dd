...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#343a40] text-white py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start space-y-4">
            ...
            <div className="flex items-center">
              <span className="text-4xl font-bold text-[#8bc34a]">D</span>
              <span className="text-4xl font-bold text-white">EAMON</span>
              <span className="text-4xl font-bold text-[#8bc34a]">DD</span>
            </div>
          ...
          <div className="flex flex-col items-center md:items-start space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center space-x-2">
                <FaMapMarkerAlt className="text-[#8bc34a]" />
