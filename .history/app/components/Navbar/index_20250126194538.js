    ...
    <nav className="bg-transparent shadow-md fixed w-full z-10">
      <div className="container mx-auto flex items-center justify-between py-4 px-6">
        ...
        <div className="flex items-center space-x-4 md:hidden block">
          <Link href="/" className="text-xl font-bold text-white hover:text-blue-600 flex items-center">
            <Image src="/assets/Logo-D-Mobile.png" width={100} height={100} alt="Mobile Deamon Icon" />
          </Link>
        </div>
        ...
        <div className="md:hidden relative">
          <Menu as="div" className="relative">
            <Menu.Button onClick={() => setIsOpen(!isOpen)} className="text-white focus:outline-none">
