...
const NavBar = () => {
  ...
  return (
    <nav
      className={`${
        isScrolled ? "bg-[#673372a8]" : "bg-transparent"
      } shadow-md fixed w-full z-20 transition-colors duration-300 z-40 `}
    >
      <div className="container mx-auto flex items-center justify-between z-20 py-4 px-6">
        ...
        <div className="hidden md:flex space-x-6">
          ...
          <Link
            href="/contact"
            className="text-gray-600 hover:text-[#673372a8] transition"
          >
            Contacto
          </Link>
        </div>
