                ...
                <button
                  ...
                  className={`block py-2 px-3 rounded-sm md:p-0  ${
                    activeLink === link.href
                      ? " text-[#67332] font-bold "
                      : "text-gray-900 hover:bg-gray-100 md:hover:bg-transparent hover:text-[#67372] md:hover:text-[#3603a] dark:text-white dark:hover:text-white"
                  }`}
                >
                  {link.label}
                </button>
