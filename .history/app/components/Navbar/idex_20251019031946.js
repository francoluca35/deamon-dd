          ...
          <div className="flex items-center space-x-2">
            {Object.values(languages).map((lang) => (
              <button
                ...
                className={`w-8 h-8 rounded-full flex items-center justify-center text-lg transition-all duration-200 hover:scale-110 ${
              ...
              >
                <div className="relative w-5 h-5 flex items-center justify-center">
                  ...
                  />
                  {/* Emoji como overlay (se mostrará si el navegador lo soporta) */}
                  <span 
