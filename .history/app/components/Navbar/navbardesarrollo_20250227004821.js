        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md relative w-full md:w-[500px]">
            ...
            {!showCalendly ? (
              <>
                ...
                <div className="relative w-full h-0 pb-[56.25%] mt-4">
                  <iframe
                    ...
                    src="https://www.youtube.com/embed/TU-ID-DEL-VIDEO"
              ...
              <>
                <h2 className="text-xl font-bold mb-4 text-center text-[#343372]">Agenda tu reunión</h2>
                
                {/* Calendly embebido */}
                <div className="w-full h-[400px]">
                  <iframe
                    src="https://calendly.com/tu-enlace"
                    width="100%"
                    height="100%"
                    frameBorder="0"
                    allowFullScreen
