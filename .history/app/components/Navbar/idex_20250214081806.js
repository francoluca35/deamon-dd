...
function Navbar2() {
  ...
  const [activeLink, setActiveLink] = useState("/"); // Agregar estado para el enlace activo
                ...
                <Link
                  ...
                  className={`block py-2 px-3 rounded-sm md:p-0 ${
                    activeLink === link.href
                      ? " text-[#673372] font-bold" // Color violeta para el enlace activo
