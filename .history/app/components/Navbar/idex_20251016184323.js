              ...
              <ul className="px-6 py-4 space-y-6">
                ...
                >
                  <div className="relative">
                    ...
                    <div className={`mt-2 space-y-3 pl-4 transition-all duration-300 ease-out ${
                      isDropdownOpen ? 'max-h-32 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'
                    }`}>
                      <button
                        onClick={() => {
                ...
                <li 
                  ...
                  style={{ 
                    transitionDelay: isOpen ? `${(navLinks.length + 1) * 50 + 100}ms` : '0ms' 
                  }}
                >
                  <button
                    onClick={() => {
