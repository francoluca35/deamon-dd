...
function Navdesarrollo() {
  ...
  useEffect(() => {
    const updateText = () => {
      setButtonText(
        window.innerWidth <= 820 ? "Reunite" : "Reunite con nosotros"
      );
    };
    ...
    >
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <button onClick={() => router.push("/")} className="flex items-center">
          <Image
            src="/assets/deamon-icon-B-desarrollo.avif"
            width={200}
            height={200}
            alt="Deamon Icon"
          />
            ...
            {!showCalendly ? (
              <>
                ...
                <p className="text-gray-700 text-center">
                  ...
                  web y software, como tambien en diseno. Nos enfocamos en
                  calidad, innovación y satisfacción del cliente.
                </p>
