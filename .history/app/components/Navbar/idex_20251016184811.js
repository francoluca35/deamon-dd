  ...
  return (
    ...
    >
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        >
          <div 
            className={`fixed top-0 right-0 h-full w-2/3 bg-black transform transition-transform duration-300 ease-in-out ${
                ...
                {navLinks.map((link) => (
                  <li key={link.href}>
                    <button
                      ...
                      className="block text-white text-lg font-bold hover:text-purple-300 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-black rounded py-2 opacity-100"
                    ...
                    {isDropdownOpen && (
                      <div className="mt-2 space-y-3 pl-4">
                        <button
                          ...
                          className="block text-white text-base hover:text-purple-300 w-full text-left transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-black rounded py-1"
