          ...
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium md:space-x-8 md:flex-row md:mt-0 z-50">
            ...
            <li className="relative">
              ...
              >
                <button
                  onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                  className="block py-2 px-3 rounded-sm md:p-0 text-white hover:text-[#673372f5] transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 rounded"
                  aria-label="Ver trabajos realizados"
                  aria-expanded={isDropdownOpen}
                  tabIndex={0}
                >
