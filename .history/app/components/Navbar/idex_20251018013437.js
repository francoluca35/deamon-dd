        ...
        <div className="hidden md:flex items-center space-x-8 flex-1 justify-center">
          {navLinks.map((link) => (
            <button
              ...
              className={`text-white hover:text-purple-300 transition-colors text-sm duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-black rounded px-3 py-2 font-medium ${
