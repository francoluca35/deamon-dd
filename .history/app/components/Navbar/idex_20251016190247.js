            ...
            {navLinks.map((link) => (
              <li key={link.href}>
                <button
                  ...
                  className="block py-2 px-3 rounded-sm md:p-0 text-white hover:text-[#b629d2a8] transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 rounded"
                  aria-label={`Navegar a ${link.label}`}
                  tabIndex={0}
                >
                  {link.label}
