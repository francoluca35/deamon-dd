    ...
    <nav className={`${
      ...
      <Link href="/" className="flex items-center">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <button type="button" className="text-white  hover:bg-[#673372a8] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-[#673372a8] dark:hover:bg-[#673372a8] dark:focus:ring-[#673372bd]">
