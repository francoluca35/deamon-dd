...
export default function Home() {
  ...
  return (
    <div>
      <div className="h-screen flex flex-col justify-center items-center bg-cover bg-center sm:bg-[url('/assets/b-mobile.png')] lg:bg-[url('/assets/background-desktop.png')]">
        <Navbar2 />
        <Inicio />
        <div id="equipo">
          <Equipo />
