...
const Vision = () => {
  ...
  return (
    <section id='equipo' className="relative flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-black to-gray-900 text-white overflow-hidden ">
      <motion.h2
