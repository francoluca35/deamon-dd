...
const projects = [
  { id: 1, title: 'E-Commerce Website', category: 'Páginas Web', image: '/images/ecommerce.jpg' },
  { id: 2, title: 'Portfolio Website', category: 'Páginas Web', image: '/images/portfolio.jpg' },
  { id: 3, title: 'Task Management App', category: 'App Web', image: '/images/task-app.jpg' },
  { id: 4, title: 'Chat Application', category: 'App Web', image: '/images/chat-app.jpg' },
  { id: 5, title: 'Inventory System', category: 'Programas Desktop', image: '/images/inventory.jpg' },
  { id: 6, title: 'Billing Software', category: 'Programas Desktop', image: '/images/billing.jpg' },
];
...
export default function TrabajosSection() {
  ...
  return (
    <div className="pt-24 px-8"> {/* Ajuste de padding-top para evitar que se solape con el navbar */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto"> {/* Alineado con el ancho del contenido */}
