...
export default function Desarrollosoft() {
  ...
  return (
    <div className="py-20 bg-gradient-to-r from-green-500 to-green-700 text-white text-center">
      <h2 className="text-5xl font-bold mb-10">Desarrollo de Software</h2>
