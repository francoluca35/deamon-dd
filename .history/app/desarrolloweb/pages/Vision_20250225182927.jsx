...
const Vision = () => {
  return (
    <section className="relative flex flex-col items-center justify-center min-h-screen bg-black text-white overflow-hidden">
      ...
      >
        We aim to create stunning digital experiences that captivate and inspire. 
        Our mission is to blend technology and design seamlessly, crafting 
        intuitive and immersive interfaces.
      </motion.p>
