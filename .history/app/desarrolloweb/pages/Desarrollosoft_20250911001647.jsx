...
const projects = [
  {
    ...
    image: "/assets/Proyectos/JLA.avif",
    url: "https://jlatecnicos.com",
    repo: "https://github.com/francoluca35/web-site-jla",
    galeria: [
      "/assets/Proyectos/app-web/jla-web-1.avif",
      "/assets/Proyectos/app-web/jla-web-2.avif",
      "/assets/Proyectos/app-web/jla-web-3.avif",
      "/assets/Proyectos/app-web/jla-web-4.avif",
    ],
  },
  {
    id: 2,
    ...
    category: "App Web",
    image: "/assets/Proyectos/perumar.avif",
    repo: "https://github.com/francoluca35/comandas",
    galeria: [
      "/assets/Proyectos/app-web/perumar-1.avif",
      "/assets/Proyectos/app-web/perumar-2.avif",
      "/assets/Proyectos/app-web/perumar-3.avif",
      "/assets/Proyectos/app-web/perumar-4.avif",
    ],
  },
  {
    id: 3,
    ...
    image: "/assets/Proyectos/maurello-web.avif",
    url: "https://empresacolectivo.vercel.app",
    repo: "https://github.com/francoluca35/empresacolectivo",

    galeria: [
      "/assets/Proyectos/app-web/maurello-web.avif",
      "/assets/Proyectos/app-web/maurello-web-2.avif",
      "/assets/Proyectos/app-web/maurello-web-3.avif",
    ],
  },
  {
    id: 4,
    ...
    galeria: [
      "/assets/Proyectos/app-web/app-jla-2.avif",
      "/assets/Proyectos/app-web/app-jla.avif",
      "/assets/Proyectos/app-web/app-jla-3.avif",
      "/assets/Proyectos/app-web/app-jla-4.avif",
    ],
  },
  {
    id: 5,
    ...
    image: "/assets/Proyectos/yael-app.avif",
    url: "https://caruso-app.vercel.app",
    repo: "https://github.com/francoluca35/yael-app/",
    galeria: [
      "/assets/Proyectos/app-web/caruso-app.avif",
      "/assets/Proyectos/app-web/caruso-app-2.avif",
      "/assets/Proyectos/app-web/caruso-app-3.avif",
    ],
  },
  {
    id: 6,
    ...
    galeria: [
      "/assets/Proyectos/app-web/maurello-app.avif",
      "/assets/Proyectos/app-web/maurello-app-2.avif",
      "/assets/Proyectos/app-web/maurello-app-3.avif",
      "/assets/Proyectos/app-web/maurello-app-4.avif",
    ],
  },
];
