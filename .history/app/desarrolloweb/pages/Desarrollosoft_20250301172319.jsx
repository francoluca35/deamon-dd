  ...
  return (
    <div className="relative group overflow-hidden shadow-lg mb-10">
      ...
      <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <h3 className="text-white text-xl font-semibold text-center px-4">{title}</h3>
...
export default function TrabajosSection() {
  ...
  return (
    <div id='trabajos' className="pt-24 px-4 sm:px-6 lg:px-8"> {/* Ajuste de padding para mejor responsividad */}
