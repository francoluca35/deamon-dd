  ...
  return (
    <html lang="es" className="scroll-smooth">
      <head>
        ...
        <link rel="preload" href="/assets/imagen-ilu.avif" as="image" type="image/avif" />
        <link rel="preload" href="/assets/fondo1.avif" as="image" type="image/avif" />
        <link rel="preload" href="/assets/deamon-icon-B-s.avif" as="image" type="image/avif" />
