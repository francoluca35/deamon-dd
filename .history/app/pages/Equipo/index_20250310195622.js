    ...
    <div className="w-full min-h-screen bg-white flex flex-col items-center justify-center px-6">
      ...
      <div ref={teamRef} className="w-full py-20 bg-gray-100 mt-20">
        <div className=" grid grid-cols-1 md:grid-cols-4 gap-0">
          {[
            { img: '/Assets/equipo/joaco.jpg', name: 'Hernán R. Suárez', role: 'Socio Fundador \n Director Creativo' },
            { img: '/Assets/equipo/joaco.jpg', name: 'Pablo', role: 'Desarrollador Web' },
            { img: '/Assets/equipo/joaco.jpg', name: 'Eli', role: 'Diseñadora Gráfica' },
            { img: '/Assets/equipo/joaco.jpg', name: 'Bros', role: 'Fotógrafo' }
          ].map((member, index) => (
            <motion.div key={index}  className="relative group w-full h-[500px] overflow-hidden">
              ...
              <div className="absolute inset-0 bg-white bg-opacity-50 flex flex-col items-center justify-center transition opacity-100 group-hover:opacity-0">
