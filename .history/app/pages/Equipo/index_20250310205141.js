...
export default function TeamSection() {
  ...
  return (
    <div className="w-full min-h-screen bg-white flex flex-col items-center justify-center px-6">
      ...
      {/* Segunda Sección (Distribución en forma de Y) */}
      <div ref={teamRef} className="w-full py-20 bg-gray-100 mt-20">
        <div className="w-screen grid grid-cols-1 md:grid-cols-3 gap-0 relative">
          <div className="col-span-3 flex justify-center">
            <motion.div className="relative group w-[33%] h-[500px] overflow-hidden">
              <img src="/Assets/equipo/yo-franco.png" alt="Franco L. Parera" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-purple-900/20 bg-opacity-30 flex flex-col items-center justify-center">
                <p className="text-black border border-white p-2 bg-white text-lg font-light">Franco L. Parera</p>
              </div>
            </motion.div>
          </div>
          <div className="col-span-1 flex justify-end">
            <motion.div className="relative group w-[50%] h-[500px] overflow-hidden">
              <img src="/Assets/equipo/joaco.jpg" alt="Markitos Parera" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-purple-900/20 bg-opacity-30 flex flex-col items-center justify-center">
                <p className="text-black border border-white p-2 bg-white text-lg font-light">Markitos Parera</p>
              </div>
            </motion.div>
          </div>
          <div className="col-span-1 flex justify-start">
            <motion.div className="relative group w-[50%] h-[500px] overflow-hidden">
              ...
              <div className="absolute inset-0 bg-purple-900/20 bg-opacity-30 flex flex-col items-center justify-center">
                <p className="text-black border border-white p-2 bg-white text-lg font-light">Joaquin Lazara</p>
              </div>
            </motion.div>
          </div>
          <div className="col-span-3 flex justify-center">
            <motion.div className="relative group w-[33%] h-[500px] overflow-hidden">
              ...
              <div className="absolute inset-0 bg-purple-900/20 bg-opacity-30 flex flex-col items-center justify-center">
                <p className="text-black border border-white p-2 bg-white text-lg font-light">Tobias Y. Benitez</p>
              </div>
            </motion.div>
          </div>
        </div>
