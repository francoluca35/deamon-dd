...
export default function TeamSection() {
  ...
  return (
    <div className="w-full min-h-screen bg-black flex flex-col items-center justify-center px-6">
      {/* Primera Sección */}
      <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-6xl gap-10 text-center md:text-left">
        <div className="w-full mt-20 md:w-1/2 flex flex-col justify-center items-center md:items-start">
      ...
      <div ref={teamRef} className=" justify-center  mt-40">
