    ...
    <div className="w-full min-h-screen bg-white flex flex-col items-center justify-center px-6">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-6xl">
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image src="/Assets/equipo/yo-franco.png" alt="Logo" width={80} height={80} />
        </div>
      </div>
      ...
      <div ref={teamRef} className="w-full py-20 bg-gray-100 mt-20">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6">
          <motion.div whileHover={{ scale: 1.05 }} className="relative group">
            <Image src="/Assets/equipo/yo-franco.png" alt="Miembro 1" className="w-full h-auto" width={80} height={80} />
