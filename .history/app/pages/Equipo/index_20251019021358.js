              ...
              <div className="absolute inset-4 bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-xl border border-purple-400/30">
                <div className="p-6 space-y-4">
                  ...
                  <div className="space-y-2 font-mono text-xs sm:text-sm overflow-x-auto">
                    ...
                    <div className="text-violet-400 ml-2 sm:ml-4">services: [</div>
                    <div className="text-green-400 ml-4 sm:ml-8">&quot;Marketing Digital&quot;,</div>
                    <div className="text-green-400 ml-4 sm:ml-8">&quot;Branding & Diseño&quot;,</div>
                    <div className="text-green-400 ml-4 sm:ml-8">&quot;Desarrollo Web&quot;,</div>
                    <div className="text-green-400 ml-4 sm:ml-8">&quot;Apps Móviles&quot;</div>
                    <div className="text-purple-400 ml-2 sm:ml-4">],</div>
                    <div className="text-orange-400 ml-2 sm:ml-4">mission: &quot;mejorar a cada cliente&quot;,</div>
                    <div className="text-orange-400 ml-2 sm:ml-4">passion: &quot;creatividad & resultados&quot;</div>
