              ...
              <div className="absolute inset-4 bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-xl border border-purple-400/30">
                <div className="p-6 space-y-4">
                  ...
                  <div className="space-y-2 font-mono text-sm">
                    ...
                    <div className="text-vio-400 ml-4">],</div>
                    <div className="text-vio-400 ml-4">mission: &quot;transformación digital&quot;,</div>
                    <div className="text-vio-400 ml-4">passion: &quot;creatividad & tecnología&quot;</div>
