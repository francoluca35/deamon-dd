      ...
      <div ref={teamRef} className="w-full py-20 bg-gray-100 mt-20">
        <div className=" grid grid-cols-1 md:grid-cols-4 gap-0">
          {[
            ...
            { img: '/Assets/equipo/joaco.jpg', name: 'Joaquin Lazara', role: 'Diseñador Gráfico \n Diseñador Automovilistico \n Estudiante en la UBA en la carrera de diseñador grafico. \n Apasionado por los autos de carrera su mayor virtud es el diseño de los autos del TC.' },
            { img: '/Assets/equipo/joaco.jpg', name: 'Tobias Y. Benitez', role: 'Desarrollador Fullstack \n Estudiante en la UTN de ing. Electronica, cumple el rol de desarrollador Backend para nuestras app´s.' }
          ].map((member, index) => (
