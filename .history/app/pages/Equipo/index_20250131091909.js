  ...
  return (
    <section className="relative bg-black text-white py-12 px-6 overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${fondo.src})`, opacity:".4" }}
      />

      {/* Contenido */}
      <div className="relative z-10">
        <h2 className="text-center text-5xl uppercase font-bold mb-8">
          Agencia de Diseño & Desarrollo
        </h2>
        <div className="grid grid-flow-col xl:grid-rows-2 2xl:grid-rows-1 sm:grid-rows-4 md:grid-rows-2 xl:gap-20 gap-6 justify-center">
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className="bg-gray-900 p-6 rounded-lg w-80 text-center relative"
            >
              <HoverImage
