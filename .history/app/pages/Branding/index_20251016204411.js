                  ...
                  >
                    {project.type === 'more-projects' ? (
                      ...
                      <a href={project.url} target="_blank" rel="noopener noreferrer" className="block w-full h-full">
                        <div className="relative aspect-square border-2 border-violet-600 flex flex-col justify-between p-6 bg-gradient-to-br from-transparent to-violet-900/20 hover:to-violet-900/40 transition-all duration-300">
                          <h3 className="text-white text-2xl font-bold text-center uppercase tracking-wide">
                            {project.name}
                          </h3>
                          <div className="flex items-center justify-center text-white text-xl font-semibold uppercase mt-auto space-x-2">
                  ...
                  {projects.filter(p => p.layout === 'rectangle').map((project, index) => (
                    ...
                    >
                      {project.type === 'more-projects' ? (
                        // Tarjeta especial "MAS PROYECTOS"
                        <a href={project.url} target="_blank" rel="noopener noreferrer" className="block w-full h-full">
                          <div className="relative aspect-square border-2 border-violet-600 flex flex-col justify-between p-6 transition-all duration-300">
                            <h3 className="text-white text-2xl font-bold text-center uppercase tracking-wide">
                              {project.name}
                            </h3>
                            <div className="flex items-center justify-center text-white text-xl font-semibold uppercase mt-auto space-x-2">
