      ...
      <div className="relative px-8 pt-24 pb-20 max-w-6xl mx-auto z-20">
        ...
        >
          ...
          <p className="text-white/70 max-w-3xl leading-relaxed mb-8">
            {isLoaded ? t("branding.description") : "Creamos identidades visuales únicas y diseñamos estrategias de marketing digital que conectan con tu audiencia. Desde el diseño de logotipos y manuales de marca completos hasta campañas publicitarias en Meta Ads, Google Ads y TikTok Ads, planificamos y optimizamos todas las acciones para que tu negocio destaque, venda y crezca."}
          </p>
          ...
          <p className="text-white/70 mb-8">
            {isLoaded ? t("branding.projectsTitle") : "A continuación explorá proyectos de branding y estrategias publicitarias con resultados reales:"}
          </p>
