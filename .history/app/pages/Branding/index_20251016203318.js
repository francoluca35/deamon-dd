    ...
    <section className="w-full min-h-screen bg-gradient-to-br from-neutral-900 via-black to-neutral-900 text-white px-6 py-20">
      <div className="max-w-6xl mx-auto">
        ...
        >
          {/* Título con logo */}
          <motion.h2 
            className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight flex items-center"
          ...
          >
            <Image
              ...
              width={60}
              height={60}
              className="w-10 h-10 md:w-12 md:h-12 lg:w-16 lg:h-16 mr-3 md:mr-4"
            />
            Branding
          </motion.h2>
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-violet-800 to-violet-600 hover:from-violet-600 hover:to-violet-700 text-white px-6 md:px-8 py-3 md:py-4 rounded-lg font-semibold text-base md:text-lg flex items-center justify-center space-x-2 transition-all duration-300 shadow-lg shadow-pink-500/20"
            >
            ...
            <motion.button
              ...
              className="bg-gray-800 hover:bg-gray-700 text-white px-6 md:px-8 py-3 md:py-4 rounded-lg font-semibold text-base md:text-lg flex items-center justify-center space-x-2 transition-all duration-300 border border-gray-600 hover:border-gray-500"
            >
          ...
          {/* Texto final */}
          <motion.p 
            className="text-base md:text-lg text-gray-400 mt-8 md:mt-12"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
              ...
              <div className="lg:col-span-2">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                  {projects.filter(p => p.layout === 'rectangle').map((project, index) => (
                    ...
                    >
                      {/* Todo dentro de la imagen */}
                      <div className="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] xl:h-[760px]">
                        <Image
                          src={project.image}
                          alt={`Proyecto ${project.name}`}
                          fill
