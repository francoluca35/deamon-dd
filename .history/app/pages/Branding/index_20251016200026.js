  ...
  const projects = [
    {
      ...
      accentGradient: "from-pink-500/20 via-transparent to-teal-500/20",
      url: "#"
    },
    {
      id: 2,
      ...
      accentGradient: "from-yellow-400/20 via-transparent to-pink-400/20",
      url: "#"
    },
    {
      id: 3,
      ...
      accentGradient: "from-green-400/20 via-transparent to-teal-400/20",
      url: "#"
    },
    {
      id: 4,
      ...
      accentGradient: "from-cyan-400/20 via-transparent to-blue-400/20",
      url: "#"
    },
    {
      id: 5,
      name: "Gusto",
      tagline: "restaurant chain",
      ...
      accentGradient: "from-yellow-400/20 via-transparent to-red-400/20",
      url: "#"
    },
    {
      id: 6,
      name: "StyleCo",
      tagline: "fashion brand",
      description: "Fashion Brand",
      logo: "F",
      color: "pink",
      gradient: "from-pink-600 via-purple-700 to-pink-800",
      hoverColor: "pink-500",
      shadowColor: "pink-500",
      accentGradient: "from-pink-400/20 via-transparent to-purple-400/20",
      url: "#"
    }
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          >
            ...
            {/* Proyecto 2 - Soyana */}
            <motion.div 
              className="bg-neutral-900 rounded-2xl overflow-hidden border border-neutral-800 hover:border-green-500/50 transition-all duration-500 cursor-pointer group shadow-2xl hover:shadow-green-500/10"
              whileHover={{ scale: 1.02, y: -5 }}
              whileTap={{ scale: 0.98 }}
            >
              <div className="relative h-48 bg-gradient-to-br from-green-500 via-emerald-600 to-green-700 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-yellow-400/20 via-transparent to-pink-400/20"></div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/30 via-transparent to-transparent"></div>
                
                {/* Efectos de iluminación */}
                <div className="absolute top-6 left-6 w-10 h-10 bg-white/15 rounded-full blur-sm"></div>
                <div className="absolute bottom-8 right-4 w-8 h-8 bg-yellow-400/40 rounded-full blur-lg"></div>
                
                <div className="absolute bottom-6 left-6">
                  <div className="w-12 h-12 bg-white/25 backdrop-blur-sm rounded-2xl flex items-center justify-center mb-3">
                    <span className="text-green-700 font-bold text-xl">S</span>
                  </div>
                  <h3 className="text-white font-bold text-2xl mb-1">SOYANA</h3>
                  <p className="text-white/70 text-sm font-light">plant-based foods</p>
                </div>
              </div>
              ...
              <div className="p-6 bg-neutral-900">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h4 className="text-white font-semibold text-lg">Soyana</h4>
                      <p className="text-neutral-400 text-sm">Organic Plant-based</p>
                    </div>
                  </div>
                  <button className="border border-white/20 text-white px-4 py-2 rounded-lg text-sm hover:bg-white/5 transition-all duration-300 backdrop-blur-sm">
                    Ver proyecto
