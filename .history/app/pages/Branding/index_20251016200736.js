    ...
    <section className="w-full min-h-screen bg-gradient-to-br from-neutral-900 via-black to-neutral-900 text-white px-6 py-20">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <motion.div 
            className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-12 max-w-7xl mx-auto"
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            {projects.map((project, index) => (
              <motion.div 
                key={project.id}
                className="relative rounded-2xl overflow-hidden border border-neutral-800 hover:border-neutral-700 transition-all duration-500 cursor-pointer group shadow-2xl"
