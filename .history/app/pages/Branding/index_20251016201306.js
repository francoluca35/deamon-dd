    ...
    <section className="w-full min-h-screen bg-gradient-to-br from-neutral-900 via-black to-neutral-900 text-white px-6 py-20">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <motion.div 
            className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-12 max-w-7xl mx-auto"
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            {projects.map((project, index) => (
              <motion.div 
                key={project.id}
                className="relative rounded-2xl overflow-hidden border border-neutral-800 hover:border-neutral-700 transition-all duration-500 cursor-pointer group shadow-2xl bg-neutral-900"
              ...
              >
                ...
                <div className={`relative ${project.size === 'large' ? 'h-80' : 'h-48'}`}>
                  <Image
                    src={project.image}
                ...
                <div className="p-6 bg-neutral-900">
                  <div className="flex items-center justify-between">
                    ...
                    <button className="border border-white/20 text-white px-4 py-2 rounded-lg text-sm hover:bg-white/5 transition-all duration-300">
                      Ver proyecto
                    </button>
                  </div>
                </div>
