...
// Carga dinámica para evitar problemas con SSR y three.js
const ModelViewer = dynamic(() => import("/components/3d/ModelViewer.tsx"), {
  ssr: false,
});
      ...
      <div className="max-w-[90%] sm:max-w-[70%] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex justify-center md:justify-end">
            <ModelViewer modelUrl="/models/tc.gltf" />
          </div>
        </div>
      </div>
    </div>
