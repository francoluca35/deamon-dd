...
function AgenciaContent({ currentLang, t, isLoaded }) {
  console.log('🎨 AGENCIA CONTENT - rendering with currentLang:', currentLang);
...
export default function TeamSection() {
  ...
  // Debug temporal
  console.log('🔍 AGENCIA MAIN - currentLang:', currentLang, 'isLoaded:', isLoaded);
  
  return <AgenciaContent key={currentLang} currentLang={currentLang} t={t} isLoaded={isLoaded} />;
}
