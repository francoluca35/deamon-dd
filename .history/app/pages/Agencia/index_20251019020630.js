...
// Componente interno que se re-renderiza
function AgenciaContent() {
  const { t, isLoaded, currentLang } = useTranslation();
  
  // Debug temporal
  console.log('🔍 AGENCIA CONTENT - currentLang:', currentLang, 'isLoaded:', isLoaded);
  console.log('🔍 AGENCIA CONTENT - t("agency.title"):', t("agency.title"));
...
export default function TeamSection() {
  ...
  return <AgenciaContent key={`${currentLang}-${renderKey}`} />;
}
