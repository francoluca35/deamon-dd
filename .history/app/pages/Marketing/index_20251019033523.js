          ...
          >
            ...
            >
              <div className="relative aspect-[3/4]">
                ...
                {/* Tags en la parte media - centrados en una línea */}
                <div className="absolute top-20 left-1/2 transform -translate-x-1/2 flex gap-2 justify-center">
                  <span className="bg-white/10 backdrop-blur-sm text-white px-4 py-2 rounded-lg text-sm font-medium border border-white/20 shadow-lg">{t("marketing.tags.advertising")}</span>
                  <span className="bg-white/10 backdrop-blur-sm text-white px-4 py-2 rounded-lg text-sm font-medium border border-white/20 shadow-lg">{t("marketing.tags.uxui")}</span>
                  <span className="bg-white/10 backdrop-blur-sm text-white px-4 py-2 rounded-lg text-sm font-medium border border-white/20 shadow-lg">{t("marketing.tags.webDev")}</span>
                </div>
