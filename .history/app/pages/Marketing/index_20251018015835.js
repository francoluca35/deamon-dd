      ...
      <div className="relative px-8 py-20 max-w-6xl mx-auto z-10">
        ...
        <div className="flex flex-col gap-4 mb-14">
          ...
          <button 
            ...
            className="border border-white/30 text-white px-6 py-2 sm:px-6 sm:py-3 rounded-lg font-semibold flex items-center gap-2 hover:bg-white/10 transition-all duration-300 backdrop-blur-sm"
          >
            Conocé la agencia
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              <div className="relative aspect-[3/4]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <h4 className="text-white text-xl font-bold mb-2">Caso de éxito | Estudio Arquimec</h4>
                  <p className="text-white/70 text-sm leading-relaxed">
                    Arquimec nos brindo la oportunidad de trabajar en su proyecto de crecimiento digital, con el objetivo de posicionarse en el mercado  para una llegada a nivel nacional.
                  </p>
                </div>
              </div>
            </motion.div>
