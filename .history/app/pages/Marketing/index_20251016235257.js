              ...
              <div className="relative aspect-[3/4]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  ...
                  <p className="text-white/70 text-sm leading-relaxed">
                    Arquimec nos brindo la oportunidad de trabajar en su proyecto de crecimiento digital, con el objetivo de posicionarse como una de las cinco concesionarias más importantes de General Motors en Argentina.
                  </p>
                </div>
              </div>
            </motion.div>
