          ...
          >
            ...
            >
              <div className="relative aspect-square bg-neutral-800">
                <Image
                  src="/assets/marketing/beta-automotores.jpg"
                  alt="Beta Automotores"
                  fill
                ...
                <div className="absolute top-4 left-4">
                  <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg">
                    <span className="text-black font-bold text-sm text-center">BETA<br/>AUTOMOTORES<br/>S.A.</span>
                  </div>
                </div>

                <div className="absolute bottom-6 left-6 right-6">
                  <h4 className="text-white text-2xl font-bold mb-1">Caso de éxito | Beta Automotores</h4>
                  <div className="flex flex-wrap gap-2 mb-3">
                    <span className="bg-gray-800/80 text-white px-2 py-1 rounded text-xs">Pauta</span>
                    <span className="bg-gray-800/80 text-white px-2 py-1 rounded text-xs">Diseño UX/UI</span>
                    <span className="bg-gray-800/80 text-white px-2 py-1 rounded text-xs">Desarrollo Web</span>
                  </div>
              ...
              <div className="relative aspect-square bg-neutral-800">
                ...
                <div className="absolute top-4 left-4">
                  <div className="w-16 h-16 bg-black rounded-full flex items-center justify-center shadow-lg">
                    <span className="text-white font-bold text-xs text-center">ZARAH CARTER<br/>GALERIA OPTICA</span>
                  </div>
                </div>

                <div className="absolute bottom-6 left-6 right-6">
                  <h4 className="text-white text-2xl font-bold mb-1">Caso de éxito | Zarah Carter</h4>
                  <div className="flex flex-wrap gap-2 mb-3">
                    <span className="bg-gray-800/80 text-white px-2 py-1 rounded text-xs">Pauta</span>
                    <span className="bg-gray-800/80 text-white px-2 py-1 rounded text-xs">Diseño UX/UI</span>
                    <span className="bg-gray-800/80 text-white px-2 py-1 rounded text-xs">Desarrollo Web</span>
            ...
            >
              <div className="relative aspect-square bg-neutral-800">
                ...
                <div className="absolute top-4 left-4">
                  <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg">
                    <span className="text-black font-bold text-lg italic">Entre-Nous</span>
                  </div>
                </div>

                <div className="absolute bottom-6 left-6 right-6">
                  <h4 className="text-white text-2xl font-bold mb-1">Caso de éxito | Entre Nous</h4>
                  <div className="flex flex-wrap gap-2 mb-3">
                    <span className="bg-gray-800/80 text-white px-2 py-1 rounded text-xs">Pauta</span>
                    <span className="bg-gray-800/80 text-white px-2 py-1 rounded text-xs">Diseño UX/UI</span>
                    <span className="bg-gray-800/80 text-white px-2 py-1 rounded text-xs">Desarrollo Web</span>
