          ...
          >
              ...
              <div className="relative w-full h-full">
                ...
                <div className="absolute top-4 left-4">
                  <div className="w-12 h-12 bg-white/90 rounded-full flex items-center justify-center shadow-lg">
                    <designProjects[0].icon className="w-6 h-6 text-violet-800" />
                  </div>
                </div>
              ...
              <div className="relative w-full h-full">
                ...
                <div className="absolute top-3 left-3">
                  <div className="w-8 h-8 bg-white/90 rounded-full flex items-center justify-center shadow-lg">
                    <designProjects[1].icon className="w-4 h-4 text-violet-800" />
                  </div>
                </div>
            ...
            >
              <div className="relative w-full h-full">
                ...
                <div className="absolute top-3 left-3">
                  <div className="w-8 h-8 bg-white/90 rounded-full flex items-center justify-center shadow-lg">
                    <designProjects[2].icon className="w-4 h-4 text-violet-800" />
                  </div>
                </div>
              ...
              <div className="relative w-full h-full">
                ...
                <div className="absolute top-2 left-2">
                  <div className="w-6 h-6 bg-white/90 rounded-full flex items-center justify-center shadow-lg">
                    <designProjects[3].icon className="w-3 h-3 text-violet-800" />
                  </div>
                </div>
