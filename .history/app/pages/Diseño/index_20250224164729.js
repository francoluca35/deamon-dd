  ...
  return (
    <div className="relative    py-16 px-6  mx-auto">
      ...
      <div className="flex justify-center mt-6">
        <button className="bg-purple-300/30 border-2 border-purple-700 text-purple-700 px-4 py-2 rounded-lg transition duration-300 hover:bg-purple-700 hover:text-white">
          Nuestros diseños
        </button>
      </div>
    </div>
