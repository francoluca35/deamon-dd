  ...
  return (
    <div className="relative    py-16 px-6  mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-10">
        ...
        <button  className="bg-purple-300/20 border-2 border-purple-700 text-purple-700 px-4 py-2 rounded-lg transition duration-300 hover:bg-purple-700 hover:text-white justify-center flex">
