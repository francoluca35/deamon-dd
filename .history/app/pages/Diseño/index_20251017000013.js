...
const Diseño = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white relative">
      ...
      {/* Servicios Section */}
      <div className="relative px-8 pb-12 z-10">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-2xl font-bold mb-8">Nuestros servicios de diseño gráfico:</h3>
          
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="flex gap-4">
              <Pencil className="text-violet-800 w-8 h-8 flex-shrink-0 mt-1" />
              <div>
                <h4 className="text-lg font-semibold text-white mb-2">Creación de Logo</h4>
            ...
            <div className="flex gap-4">
              <Palette className="text-violet-800 w-8 h-8 flex-shrink-0 mt-1" />
              <div>
                <h4 className="text-lg font-semibold text-white mb-2">Identidad Corporativa</h4>
                <p className="text-gray-200">
                  La identidad corporativa es un conjunto de elementos gráficos que
                  toda organización requiere para diferenciarse del resto. Creamos
                  sistemas completos de identidad visual.
                </p>
              </div>
            </div>

            <div className="flex gap-4">
              <Layers className="text-violet-800 w-8 h-8 flex-shrink-0 mt-1" />
              <div>
                <h4 className="text-lg font-semibold text-white mb-2">Material Gráfico</h4>
                <p className="text-gray-200">
                  Llevamos a cabo composiciones de alto impacto visual y personalizadas de
                  folletos, tarjetas personales, banners y material promocional.
                </p>
              </div>
            </div>

            <div className="flex gap-4">
              <Zap className="text-violet-800 w-8 h-8 flex-shrink-0 mt-1" />
              <div>
                <h4 className="text-lg font-semibold text-white mb-2">Diseño Digital</h4>
                <p className="text-gray-200">
                  Creamos diseños optimizados para medios digitales, redes sociales,
                  web y aplicaciones móviles con enfoque en la experiencia del usuario.
                </p>
              </div>
            </div>
          </div>
