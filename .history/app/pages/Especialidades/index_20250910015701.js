...
export default function Especialidades() {
    ...
    const especialidades = [
      { titulo: "CREACIÓN DIGITAL", descripcion: "La construcción de plataformas digitales es la clave para llevar tu negocio al siguiente nivel. No se trata solo de tener una página bonita, sino de crear una plataforma estratégica que convierta visitantes en clientes", imagen: "/assets/grafic.jpg" },
      { titulo: "DISEÑO GRÁFICO", descripcion: "Potenciamos tu marca con identidad visual única y profesional.", imagen: "/assets/diseño-web.jpg" },
      ...
      { titulo: "DESARROLLO SOFTWARE", descripcion: "Soluciones digitales a medida para optimizar tu negocio.", imagen: "/assets/software.jpg" },
    ];
