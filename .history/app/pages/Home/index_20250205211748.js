    ...
    >
      <div className="container mx-auto flex items-center justify-between py-4 px-4 sm:px-6">
        ...
        <div className="hidden md:flex space-x-6">
          ...
          <Link href="/contact" className="bg-purple-400 text-white px-2 py-1 rounded-lg hover:bg-purple-500 transition duration-300">Contacto</Link>
        </div>
          ...
          <Menu as="div" className="relative">
            ...
            >
              <Menu.Items className="absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-lg focus:outline-none">
                {["Inicio", "Equipo", "Desarrollo Web", "Diseño Gráfico", "Trabajos", "Contacto"].map((label, index) => (
                  <Menu.Item key={index}>
                    {({ active }) => (
                      <Link
