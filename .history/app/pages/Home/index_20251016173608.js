...
export default function Home() {
  ...
  return (
    <motion.div
      ...
      style={{ 
        background: `
          radial-gradient(ellipse 1800px 1200px at 15% 15%, #ff6b9d 0%, #ff8fa3 15%, transparent 65%),
          radial-gradient(ellipse 1600px 1000px at 85% 25%, #ff9a9e 0%, #ffb3ba 20%, transparent 70%),
          radial-gradient(ellipse 1400px 800px at 50% 70%, #ffc3e1 0%, #ffd1dc 25%, transparent 75%),
          radial-gradient(ellipse 1000px 600px at 5% 85%, #ffa8cc 0%, transparent 60%),
          radial-gradient(ellipse 800px 500px at 95% 60%, #ffb6c1 0%, transparent 55%),
          linear-gradient(45deg, #ff9a9e 0%, #ffc3e1 20%, #ffb6c1 40%, #ff8fa3 60%, #ff6b9d 80%, #ff9a9e 100%)
        `,
        minHeight: "120vh"
      }}
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-radial from-pink-100/30 via-pink-50/20 to-transparent rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-radial from-pink-200/25 via-transparent to-transparent rounded-full blur-2xl"></div>
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-radial from-pink-100/20 via-transparent to-transparent rounded-full blur-2xl"></div>
      
      {/* Overlay muy sutil para contraste del texto */}
