  ...
  return (
    <div className="relative w-full h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: 'url(/assets/fondo.png)' }}>
      ...
      <div className="relative w-full flex justify-center items-center mt-8 md:mt-16">
        <div className="absolute transform rotate-[-10deg] z-30 left-[-100%] md:left-[10%]">
          <Image
        ...
        <div className="absolute transform rotate-[-20deg] z-50 left-[35%] w-[30%] ml-[12%] mt-[-22%]">
          <Image
            src="/assets/joa.jpg"
            width={600}
            height={600}
        ...
        <div className="absolute transform rotate-[10deg] scale-x-[-1] z-30 left-[30%] mt-[35%]">
          <Image
