...
export default function Home() {
  ...
  return (
    <motion.div
      ...
      style={{ 
        background: `
          radial-gradient(ellipse 2500px 1500px at 15% 15%, #ff6ec4 0%, #ff8ad9 20%, transparent 65%),
          radial-gradient(ellipse 2000px 1200px at 85% 25%, #7873f5 0%, #ff9a8b 25%, transparent 70%),
          radial-gradient(ellipse 1800px 1000px at 50% 70%, #e863e0 0%, #ff6ec4 35%, transparent 75%),
          radial-gradient(ellipse 1400px 800px at 5% 85%, #ff8ad9 0%, transparent 60%),
          radial-gradient(ellipse 1200px 600px at 95% 60%, #ff9a8b 0%, transparent 55%),
          radial-gradient(ellipse 1000px 500px at 30% 40%, #ff6ec4 0%, transparent 50%),
          linear-gradient(-45deg, #ff6ec4, #7873f5, #ff9a8b, #ff6ec4, #ff8ad9, #e863e0)
        `,
        backgroundSize: '500% 500%, 400% 400%, 600% 600%, 300% 300%, 400% 400%, 200% 200%, 500% 500%',
        animation: 'gradientShift 18s ease infinite, gradientShift2 22s ease infinite reverse, gradientShift3 28s ease infinite',
        minHeight: "120vh"
      }}
    ...
    >
      {/* Overlay idéntico a elementor-background-overlay */}
