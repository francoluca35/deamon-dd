...
export default function Home() {
  ...
  return (
    <motion.div
      ...
      style={{ 
        background: `
          radial-gradient(ellipse 2000px 1200px at 20% 20%, #ff6ec4 0%, #ff8ad9 25%, transparent 60%),
          radial-gradient(ellipse 1800px 1000px at 80% 30%, #7873f5 0%, #ff9a8b 30%, transparent 70%),
          radial-gradient(ellipse 1600px 800px at 50% 70%, #e863e0 0%, #ff6ec4 40%, transparent 80%),
          radial-gradient(ellipse 1200px 600px at 10% 80%, #ff8ad9 0%, transparent 60%),
          radial-gradient(ellipse 1000px 500px at 90% 60%, #ff9a8b 0%, transparent 55%),
          linear-gradient(-45deg, #ff6ec4, #7873f5, #ff9a8b, #ff6ec4, #ff8ad9, #e863e0)
        `,
        backgroundSize: '400% 400%, 300% 300%, 500% 500%, 200% 200%, 300% 300%, 400% 400%',
        animation: 'gradientShift 15s ease infinite, gradientShift2 20s ease infinite reverse, gradientShift3 25s ease infinite',
        minHeight: "120vh"
      }}
    ...
    >
      {/* Efectos de luz muy sutiles */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-radial from-pink-50/20 via-transparent to-transparent rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-radial from-pink-100/15 via-transparent to-transparent rounded-full blur-2xl"></div>
      
      {/* Overlay mínimo para contraste del texto */}
