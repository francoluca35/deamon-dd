...
export default function Home() {
  ...
  return (
    <motion.div
      ...
      style={{ 
        background: `
          radial-gradient(ellipse at top right, #ff6b9d 0%, transparent 50%),
          radial-gradient(ellipse at bottom left, #ff9a9e 0%, transparent 50%),
          radial-gradient(ellipse at center, #ffc3e1 0%, transparent 70%),
          linear-gradient(135deg, #ff9a9e 0%, #fecfef 25%, #fecfef 50%, #ff6b9d 75%, #ff9a9e 100%)
        `,
        minHeight: "120vh"
      }}
