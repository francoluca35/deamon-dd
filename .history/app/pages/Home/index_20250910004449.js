      ...
      <div className="relative z-10 w-full max-w-screen-xl flex flex-col-reverse md:flex-row items-center justify-between gap-8 py-10">
        ...
        <div className="text-white w-full md:w-1/2 text-center md:text-left px-4">
          ...
          <p className="text-base sm:text-lg md:text-xl mb-6 drop-shadow-[0_1px_3px_rgba(0,0,0,0.5)]">
            Somos una empresa creativa especializada en soluciones tecnológicas, nuestro único
            propósito es ayudarte a potenciar tu marca. Conoce nuestros 
            <a 
              href="/desarrolloweb" 
            ...
            >servicios de programación</a>
            y 
            <a 
              href="/graphic" 
              className="text-purple-300 hover:text-purple-200 underline mx-1 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 rounded"
              tabIndex={0}
              aria-label="Ver servicios de diseño gráfico"
