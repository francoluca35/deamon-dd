    ...
    >
      ...
      <div className="relative z-10 max-w-screen-xl w-full px-4 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="text-left text-white mb-10 md:mt-0 -mt-60  md:mb-0 md:w-1/2 ">
          <h1 className="text-4xl md:text-6xl text-center md:text-left font-bold mb-4 leading-tight">
            HACEMOS DE TU MARCA ALGO ÚNICO
          </h1>
          <p className="text-lg md:text-xl text-center md:text-left mb-6 max-w-xl">
      ...
      <div className="md:hidden absolute -mb-10 bottom-10 w-full flex justify-center px-4">
        <Image
          src="/assets/imagen-ilu.png"
          width={500}
          height={400}
