...
export default function Home() {
  ...
  return (
    <motion.div
      ...
      style={{ 
        background: `
          radial-gradient(ellipse 1400px 900px at 15% 25%, #ff1493 0%, #ff69b4 30%, transparent 70%),
          radial-gradient(ellipse 1200px 700px at 85% 15%, #ff69b4 0%, #ffb6c1 40%, transparent 80%),
          radial-gradient(ellipse 1000px 1200px at 50% 80%, #ffb6c1 0%, #ffc0cb 50%, transparent 90%),
          radial-gradient(ellipse 800px 500px at 30% 5%, #ffc0cb 0%, transparent 60%),
          radial-gradient(ellipse 600px 900px at 75% 70%, #ff91a4 0%, transparent 70%),
          radial-gradient(ellipse 400px 400px at 5% 85%, #ffa0b4 0%, transparent 80%),
          linear-gradient(135deg, #ff1493 0%, #ff69b4 15%, #ffb6c1 35%, #ffc0cb 55%, #ff91a4 75%, #ffa0b4 100%)
        `,
        minHeight: "120vh"
      }}
    ...
    >
      {/* Efectos de brillo y flujo orgánico */}
      <div className="absolute inset-0 bg-gradient-to-br from-transparent via-white/8 to-transparent"></div>
      <div className="absolute inset-0 bg-gradient-to-tl from-pink-200/25 via-transparent to-magenta-200/20"></div>
      <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-pink-100/35 to-transparent"></div>
      
      {/* Efectos de luz adicionales */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-radial from-pink-200/40 via-pink-100/20 to-transparent rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-radial from-magenta-200/30 via-transparent to-transparent rounded-full blur-2xl"></div>
        ...
        <div className="text-white w-full md:w-1/2 text-center md:text-left px-4 order-2 md:order-1">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
            <a
              ...
              className="px-4 sm:px-6 py-3 bg-green-600 text-white font-semibold hover:bg-green-700 transition-all duration-200 rounded-lg shadow-md text-center focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 flex items-center justify-center gap-2 text-sm sm:text-base min-h-[48px]"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-4 sm:px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold hover:from-purple-600 hover:to-pink-600 transition-all duration-200 rounded-lg shadow-md text-center focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 flex items-center justify-center gap-2 text-sm sm:text-base min-h-[48px]"
