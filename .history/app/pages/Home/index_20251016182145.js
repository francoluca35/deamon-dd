  ...
  return (
    ...
    >
      ...
      <div className="floating-particles">
        ...
        <div className="particle-9"></div>
        <div className="particle-10"></div>
        <div className="particle-11"></div>
        <div className="particle-12"></div>
        <div className="particle-13"></div>
        <div className="particle-14"></div>
        <div className="particle-15"></div>
        <div className="particle-16"></div>
        <div className="particle-17"></div>
        <div className="particle-18"></div>
        <div className="particle-19"></div>
        <div className="particle-20"></div>
      </div>
