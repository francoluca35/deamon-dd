    ...
    >
      ...
      <div className="ml-10 md:ml-44 z-10 text-left text-white w-auto">
        ...
        <div className="flex w-full justify-center md:justify-start">
          <button onClick={() => handleLinkClick(link.href, link.isRoute)} className="px-6 py-3 -ml-10 sm:-ml-0 border border-purple-500 text-purple-500 hover:bg-purple-500 hover:text-white transition rounded-lg">
            NUESTRO EQUIPO
          </button>
        </div>
      </div>
