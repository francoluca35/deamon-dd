        ...
        <div className="text-white w-full md:w-1/2 text-center md:text-left px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <button
              ...
              className="px-6 py-3 border border-purple-400 text-white font-semibold hover:bg-purple-500 hover:text-white transition rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
            ...
            <a
              href="#desarrollo"
              className="px-6 py-3 bg-purple-600 text-white font-semibold hover:bg-purple-700 transition rounded-lg shadow-md text-center focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
              aria-label="Ver nuestros servicios de desarrollo web"
            >
              NUESTROS SERVICIOS
            </a>
          </div>
