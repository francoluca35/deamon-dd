...
export default function Home() {
  ...
  return (
    <motion.div
      ...
      style={{ 
        background: `
          radial-gradient(ellipse 2000px 1000px at 20% 20%, #ff6b9d 0%, #ff8fa3 20%, transparent 60%),
          radial-gradient(ellipse 1500px 800px at 80% 10%, #ff9a9e 0%, #ffb3ba 30%, transparent 70%),
          radial-gradient(ellipse 1200px 1000px at 50% 60%, #ffc3e1 0%, #ffd1dc 40%, transparent 80%),
          radial-gradient(ellipse 800px 600px at 10% 80%, #ffa8cc 0%, transparent 70%),
          radial-gradient(ellipse 600px 400px at 90% 70%, #ffb6c1 0%, transparent 60%),
          linear-gradient(135deg, #ff9a9e 0%, #ffc3e1 25%, #ffb6c1 50%, #ff8fa3 75%, #ff6b9d 100%)
        `,
        minHeight: "120vh"
      }}
