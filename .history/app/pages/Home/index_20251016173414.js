...
export default function Home() {
  ...
  return (
    <motion.div
      ...
      style={{ 
        background: `
          radial-gradient(ellipse 800px 600px at 80% 20%, #ff6b9d 0%, transparent 60%),
          radial-gradient(ellipse 600px 800px at 20% 80%, #ff9a9e 0%, transparent 60%),
          radial-gradient(ellipse 1000px 400px at 50% 50%, #ffc3e1 0%, transparent 70%),
          radial-gradient(ellipse 400px 600px at 70% 60%, #ff8a95 0%, transparent 50%),
          linear-gradient(135deg, #ff9a9e 0%, #fecfef 15%, #ffc3e1 35%, #ff6b9d 55%, #ff8a95 75%, #ff9a9e 100%)
        `,
        minHeight: "120vh"
      }}
