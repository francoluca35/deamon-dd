...
export default function Home() {
  ...
  return (
    <motion.div
      ...
      className="relative w-full min-h-screen ios-viewport-fix mobile-viewport mobile-home-extended flex items-center justify-center px-4 overflow-hidden animated-gradient-bg"
      style={{ 
        minHeight: "120vh"
      }}
