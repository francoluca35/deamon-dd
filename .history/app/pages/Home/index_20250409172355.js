...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className="ml-10 md:ml-44 z-10 text-left text-white w-auto">
        ...
        <div className="flex w-full justify-center md:justify-start">
          <button
            ...
            className="px-6 py-3 -ml-10 sm:-ml-0 border border-purple-500 text-purple-500 hover:bg-purple-500 hover:text-white transition rounded-lg"
          >
            NUESTRO EQUIPO
          </button>
        </div>
      ...
      <div className="hidden md:flex relative w-full justify-center items-center mt-8 md:mt-16 overflow-hidden">
        <div className="relative z-10 transform rotate-[-10deg] translate-x-[-5%] max-w-[90%]">
          <Image
            src="/assets/imagen-ilu.png"
            width={900}
            height={100}
