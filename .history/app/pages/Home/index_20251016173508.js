...
export default function Home() {
  ...
  return (
    <motion.div
      className="relative w-full min-h-screen ios-viewport-fix mobile-viewport mobile-home-extended flex items-center justify-center px-4"
      style={{ 
        background: `
          radial-gradient(ellipse 1200px 800px at 20% 30%, #ff1493 0%, transparent 50%),
          radial-gradient(ellipse 1000px 600px at 80% 20%, #ff69b4 0%, transparent 60%),
          radial-gradient(ellipse 800px 1000px at 60% 70%, #ffb6c1 0%, transparent 70%),
          radial-gradient(ellipse 600px 400px at 40% 10%, #ffc0cb 0%, transparent 40%),
          radial-gradient(ellipse 400px 800px at 90% 60%, #ff91a4 0%, transparent 50%),
          radial-gradient(ellipse 300px 300px at 10% 80%, #ffa0b4 0%, transparent 60%),
          linear-gradient(45deg, #ff1493 0%, #ff69b4 20%, #ffb6c1 40%, #ffc0cb 60%, #ff91a4 80%, #ffa0b4 100%)
        `,
        minHeight: "120vh"
      }}
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-tl from-pink-200/20 via-transparent to-magenta-200/20"></div>
      <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-pink-100/30 to-transparent"></div>
