...
export default function Home() {
  ...
  return (
    ...
    >
      {/* Efectos de luz dinámicos para simular video */}
      <div className="absolute inset-0 bg-gradient-to-br from-transparent via-white/5 to-transparent animate-pulse"></div>
      <div className="absolute inset-0 bg-gradient-to-tl from-pink-200/10 via-transparent to-purple-200/10 animate-pulse" style={{animationDelay: '2s', animationDuration: '8s'}}></div>
