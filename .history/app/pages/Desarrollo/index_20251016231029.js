    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-900 via-black to-neutral-900 text-white">
      ...
      <div className="px-8 py-20 max-w-6xl mx-auto">
        ...
        <div className="text-right" dir="rtl">
          ...
          <p className="text-white/70 max-w-3xl leading-relaxed mb-8 ml-auto">
      ...
      <div className="px-8 pb-24 -mt-12">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-2xl font-bold mb-8 text-right" dir="rtl">A continuación explora algunos proyectos webs desarrollados:</h3>
