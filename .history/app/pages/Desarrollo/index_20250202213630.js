...
const Desarrollo = () => {
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-white text-black py-12 px-6 overflow-hidden">
      {/* Contenedor del fondo */}
      <div
        className="absolute inset-0 w-full h-full bg-no-repeat bg-center z-0"
        style={{
          backgroundImage: `url(${fondo.src})`,
          backgroundSize: "contain", // Mantiene la imagen completa sin recortarla
      ...
      {/* Contenido */}
      <div className="relative z-10 w-full max-w-5xl text-center bg-white/80 p-6 rounded-lg">
