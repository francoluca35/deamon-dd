        ...
        <div className="flex flex-col items-center gap-10 mt-10">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-6 w-full max-w-4xl">
            <p className="w-full md:w-1/2 bg-purple-900/90 text-white p-4 rounded-lg">
              ...
              innovadoras. <br />    <a href="#contacto" className="text-purple-300 hover:text-white underline transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 rounded" tabIndex={0}>
                Contacta con nosotros</a> <br />
