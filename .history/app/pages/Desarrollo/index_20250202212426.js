  ...
  return (
    <div className="relative bg-white text-black py-12 px-6 overflow-hidden">
      ...
      <div className="relative z-10">
        <h2 className="text-center text-sm uppercase bg-purple-900/90">Potencia tu presencia digital</h2>
        <h1 className="text-center text-black text-3xl font-bold mt-2 bg-purple-900/90 w-screen">
        ...
        <div className="flex flex-col items-center gap-10 mt-10">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 w-full max-w-4xl">
            <p className="w-full md:w-1/2 bg-purple-900/90 text-black p-4 rounded-lg">
