      ...
      <div className="relative z-10 w-full max-w-7xl text-center p-6 rounded-lg">
        ...
        <div className="flex flex-col items-center gap-10 mt-10">
          ...
          <button
            ...
            className="bg-purple-300/20 border-2 border-purple-700 text-purple-700 px-4 py-2 rounded-lg transition duration-300 hover:bg-purple-700 hover:text-white"
          >
