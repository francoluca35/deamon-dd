    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl text-center p-6 rounded-lg">
        ...
        <h2
          ...
          style={{ opacity, transition: "opacity 0.3s ease-in-out" }}
        >
          Creación de Sitios de Alto Impacto
        </h2>
        ...
        <div className="flex flex-col items-center gap-10 mt-10">
          <div className="flex flex-col md:flex-row items-center gap-6 w-full max-w-4xl">
            <p className="w-full md:w-1/2 bg-purple-900/90 text-white p-4 rounded-lg">
              ...
              de expertos en <a href="/desarrolloweb" className="text-purple-300 hover:text-white underline transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 rounded" tabIndex={0}>desarrollo web profesional</a>.
            </p>
            <Image
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-6 w-full max-w-4xl">
            <p className="w-full md:w-1/2 bg-purple-900/90 text-white p-4 rounded-lg">
              ...
              para conocer más sobre nuestros <a href="/graphic" className="text-purple-300 hover:text-white underline transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 rounded" tabIndex={0}>servicios de diseño</a>.
            </p>
            <Image
