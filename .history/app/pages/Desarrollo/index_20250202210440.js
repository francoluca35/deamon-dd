  ...
  return (
    <div className="relative bg-white text-black py-12 px-6 overflow-hidden">
         <div
              ...
              />
      <h2 className="text-center text-sm uppercase z-40">Potencia tu presencia digital</h2>
      <h1 className="text-center text-3xl font-bold mt-2 z-40">
        Desarrollo Web de Alto Impacto
      </h1>

      <div className="flex flex-col items-center gap-10 mt-10 z-40">
