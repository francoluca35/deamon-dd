      ...
      <div className="relative z-10 w-full max-w-7xl text-center p-6 rounded-lg">
        ...
        <div className="flex flex-col items-center gap-10 mt-10">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-6 w-full max-w-4xl">
            <p className="w-full md:w-1/2 bg-purple-900/90 text-white p-4 rounded-lg">
            Desarrollar plataformas que puedan manejar un alto volumen de tráfico o usuarios sin perder rendimiento, y que se puedan adaptar fácilmente al crecimiento futuro.

Innovación y diferenciación: Crear soluciones que se destaquen de la competencia, bien sea por un diseño único, funciones novedosas o tecnologías innovadoras.
            </p>
            <img
              src="/assets/proyectos/portfolio.jpg"
              className="rounded-lg"
              alt="Imagen 2"
              width={400}
              height={150}
