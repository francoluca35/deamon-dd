...
const Desarrollo = () => {
  ...
  return (
    <div className="bg-neutral-950 text-white relative">
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 opacity-10 pointer-events-none z-0">
        <div className="absolute top-32 left-10 text-purple-400 font-mono text-sm animate-pulse">
          &lt;div className=&quot;web-development&quot;&gt;
        </div>
        <div className="absolute top-44 left-20 text-purple-400 font-mono text-sm animate-pulse delay-300">
          &lt;website&gt;Responsive&lt;/website&gt;
        </div>
        <div className="absolute top-56 left-10 text-purple-400 font-mono text-sm animate-pulse delay-500">
          &lt;/div&gt;
        </div>
        <div className="absolute top-72 right-20 text-violet-400 font-mono text-sm animate-pulse delay-700">
      ...
      {/* Hero */}
      <div className="relative px-8 pt-24 pb-20 max-w-6xl mx-auto z-10">
