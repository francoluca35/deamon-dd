      ...
      <div className="px-8 pb-24">
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            {/* LEFT - large tall card (row-span-2 on md+) */}
            <motion.div
              className="relative rounded-2xl overflow-hidden shadow-2xl group md:row-span-2"
              whileHover={{ scale: 1.01, y: -6 }}
              transition={{ duration: 0.25 }}
            >
              <div className="relative w-full h-full bg-neutral-800">
                {/* Imagen: reemplazá src */}
                <Image
                  src="/images/tokn.png"
                  alt="Tokn"
                  fill
                ...
                <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between">
                  <div>
                    <span className="inline-block bg-black/60 text-white px-3 py-1 rounded-full text-xs mb-2">Tokn1</span>
                    <h4 className="text-white text-2xl font-bold">Tokn1</h4>
                    <p className="text-white/70 text-sm">Startup • Plataforma Exchange</p>
                  </div>

                  <button className="ml-4 border border-white/30 text-white px-4 py-2 rounded-lg text-sm hover:bg-white/10 transition-all duration-200">
                    Ver proyecto
                  </button>
                </div>
              </div>
            ...
            >
              <div className="relative w-full h-full bg-neutral-800">
                ...
                <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between">
                  <div>
                    <h4 className="text-white text-xl font-bold">La Vía</h4>
            ...
            >
              <div className="relative w-full h-full bg-neutral-800">
                ...
                <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between">
                  <div>
                    <h4 className="text-white text-xl font-bold">Tropical Paradise</h4>
                    <p className="text-white/70 text-sm">Desarrolladora de proyectos en el Caribe</p>
                  </div>
                  <button className="ml-4 border border-white/30 text-white px-4 py-2 rounded-lg text-sm hover:bg-white/10 transition-all duration-200">
                    Ver proyecto
                  </button>
            ...
            {/* RIGHT - large tall card (row-span-2 on md+) */}
            <motion.div
              className="relative rounded-2xl overflow-hidden shadow-2xl group md:row-span-2"
              whileHover={{ scale: 1.01, y: -6 }}
              transition={{ duration: 0.25 }}
            >
              <div className="relative w-full h-full bg-neutral-800">
                ...
                <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between">
                  <div>
                    <span className="inline-block bg-white/80 text-black px-3 py-1 rounded-full text-xs mb-2">La Florida</span>
                    <h4 className="text-white text-2xl font-bold">La Florida</h4>
                    <p className="text-white/70 text-sm">Proyecto Inmobiliario</p>
                  </div>
