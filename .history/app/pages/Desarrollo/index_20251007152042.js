  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl text-center p-6 rounded-lg">
        <h2
          className="text-sm uppercase text-gray-800 font-semibold mb-2"
          style={{ opacity: Math.max(opacity, 0.9), transition: "opacity 0.3s ease-in-out" }}
        >
          Potencia tu presencia digital
        </h2>
        <h2
          className="text-center text-2xl sm:text-5xl md:text-5xl uppercase font-bold mb-8 text-black drop-shadow-sm"
          style={{ opacity: Math.max(opacity, 0.95), transition: "opacity 0.3s ease-in-out" }}
        >
