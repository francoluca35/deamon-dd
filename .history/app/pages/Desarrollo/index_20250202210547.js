...
const Desarrollo = () => {
  return (
    <div className="relative  text-black py-12 px-6 overflow-hidden">
         <div
                className="absolute top-0 left-0 w-screen h-full bg-cover bg-center"
                style={{ backgroundImage: `url(${fondo.src})`, opacity:"1", zIndex:"1", }}
              />
      <h2 className="text-center text-sm uppercase z-50">Potencia tu presencia digital</h2>
      <h1 className="text-center text-3xl font-bold mt-2 z-50">
        Desarrollo Web de Alto Impacto
      </h1>

      <div className="flex flex-col items-center gap-10 mt-10 z-50">
