        ...
        <div className="flex flex-col items-center gap-10 mt-10">
          <div className="flex flex-col md:flex-row items-center gap-6 w-full max-w-4xl">
            <p className="w-full md:w-1/2 bg-purple-900/90 text-white p-4 rounded-lg">
              Mejorar la experiencia del usuario (UX), Crear interfaces
              intuitivas y atractivas que faciliten la navegación y hagan que
              los usuarios interactúen de manera más efectiva con el sitio. 
              <a href="#equipo" className="text-purple-300 hover:text-white underline transition-colors">Conoce nuestro equipo</a> 
              de expertos en <a href="/desarrolloweb" className="text-purple-300 hover:text-white underline transition-colors">desarrollo web profesional</a>.
            </p>
            <Image
              src="/assets/desarrollo-2.png"
              className="rounded-lg"
              alt="Desarrollo web profesional con experiencia de usuario optimizada"
              width={400}
              height={250}
              loading="lazy"
              placeholder="blur"
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-6 w-full max-w-4xl">
            <p className="w-full md:w-1/2 bg-purple-900/90 text-white p-4 rounded-lg">
              Desarrollamos plataformas que puedan manejar un alto volumen de
              ...
              donde creamos soluciones que se destaquen de la competencia, bien
              sea por un diseño único, funciones novedosas o tecnologías
              innovadoras. <a href="#contacto" className="text-purple-300 hover:text-white underline transition-colors">Contacta con nosotros</a> 
              para conocer más sobre nuestros <a href="/graphic" className="text-purple-300 hover:text-white underline transition-colors">servicios de diseño</a>.
            </p>
            <Image
              src="/assets/desarrollo.png"
              className="rounded-lg"
              alt="Plataformas web escalables y de alto rendimiento"
              width={400}
              height={150}
              loading="lazy"
              placeholder="blur"
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              aria-label="Ver ejemplos de páginas web desarrolladas"
            >
