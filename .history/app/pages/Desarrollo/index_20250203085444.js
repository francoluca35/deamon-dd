...
const Desarrollo = () => {
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-white text-black py-1 px-1 overflow-hidden">
      ...
      {/* Contenido */}
      <div className="relative z-10 w-full max-w-7xl text-center  p-10 rounded-lg ">
