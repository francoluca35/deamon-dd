...
const Contacto = () => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-5xl bg-purple-900/50 rounded-lg shadow-xl overflow-hidden flex flex-col lg:flex-row">
        {/* Formulario */}
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            {[
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm"
              />
            ))}
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-2xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm resize-none"
            ></textarea>
