          ...
          <form className="space-y-4 " onSubmit={handleSubmit} noValidate>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-white/35 text-white px-4 py-3 rounded-2xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-900 text-sm resize-none transition-colors"
              ></textarea>
            </div>
