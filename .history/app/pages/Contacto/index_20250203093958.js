  ...
  return (
            ...
            <div key={id}>
              ...
              {isTextarea ? (
                <textarea
                  ...
                  className={`bg-transparent w-full p-2 border rounded-md focus:outline-none transition-transform duration-300 ${
    activeField === id ? "scale-105" : "scale-95"
                ...
                <input
                  ...
                  onFocus={() => setActiveField(id)}
                  onBlur={() => setActiveField(null)}
                  className={`w-full bg-transparent p-2 border rounded-md focus:outline-none transition-transform duration-300 ${
    activeField === id ? "scale-105" : "scale-95"
  }`}
                />
              )}
