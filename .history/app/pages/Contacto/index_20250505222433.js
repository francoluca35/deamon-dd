...
const Contacto = () => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-5xl bg-black/20 rounded-lg shadow-xl overflow-hidden flex flex-col lg:flex-row">
        {/* Formulario */}
        <div className="w-full lg:w-2/3 p-8 backdrop-blur-sm">
          ...
          <p className="text-white text-base mb-6 drop-shadow-sm">
