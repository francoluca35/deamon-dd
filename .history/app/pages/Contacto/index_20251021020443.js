...
const Contacto = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('https://res.cloudinary.com/dhmswq45h/image/upload/v1761018652/deamon-dd/contacto/contacto.jpg')",
    ...
    >
      <div className="w-full max-w-5xl bg-black/40 rounded-lg shadow-xl overflow-hidden flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/3 bg-purple-950 text-white p-8 flex flex-col justify-center">
          ...
          <p className="text-sm">{isLoaded ? t("contact.company.tagline") : "Diseño & Desarrollo"}</p>
          <p className="text-xs mt-2">
            {isLoaded ? t("contact.company.description") : "Especialistas en brindar un servicio que garantice seguridad"}
          </p>

          <div className="mt-3 text-left">
            <Image
              src="https://res.cloudinary.com/dhmswq45h/image/upload/v1761018642/deamon-dd/home/firma3.png"
