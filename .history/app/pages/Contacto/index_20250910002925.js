      ...
      <div className="w-full max-w-5xl bg-black/40 rounded-lg shadow-xl overflow-hidden flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-2/3 p-8 backdrop-blur-sm">
          ...
          <p className="text-white text-base mb-6 mt-2 drop-shadow-sm">
            ...
            <a href="#equipo" className="text-purple-300 hover:text-white underline transition-colors"> conocer nuestro equipo</a> 
            o ver nuestros <a href="/desarrolloweb" className="text-purple-300 hover:text-white underline transition-colors">trabajos de desarrollo web</a>.
          </p>
            ...
            {[
              ...
              <div key={id}>
                ...
                <input
                  ...
                  className="w-full text-black px-4 py-3 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-900 text-sm transition-colors"
                />
              </div>
            ))}
        ...
        <div className="w-full lg:w-1/3 bg-purple-900 text-white p-8 flex flex-col justify-center">
          ...
          <p className="text-xs mt-2">
            Especialistas en <a href="/desarrolloweb" className="text-purple-300 hover:text-white underline transition-colors">desarrollo web</a> 
            y <a href="/graphic" className="text-purple-300 hover:text-white underline transition-colors">diseño gráfico</a> en Buenos Aires.
          </p>
