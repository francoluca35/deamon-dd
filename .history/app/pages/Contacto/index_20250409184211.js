            ...
            <div key={id}>
              ...
              {isTextarea ? (
                ...
                <input
                  ...
                  className={`w-full bg-transparent text-white border-b-6 border-gray-100 focus:border-purple-500 placeholder-gray-400 p-2 focus:outline-none transition-colors duration-300`}
                />
              )}
            </div>
          ))}
