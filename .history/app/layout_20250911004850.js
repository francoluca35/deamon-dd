  ...
  return (
    <html lang="es" className="scroll-smooth">
      <head>
        ...
        {/* Preload optimizado para móvil */}
        <link rel="preload" href="/assets/imagen-ilu.avif" as="image" type="image/avif" media="(min-width: 768px)" />
        <link rel="preload" href="/assets/deamon-icon-B-s.avif" as="image" type="image/avif" media="(max-width: 767px)" />
