...
export default function Home() {
  ...
  if (loading) {
    return (
      <div className="h-screen flex flex-col justify-center items-center bg-cover bg-center xl:bg-[url('/assets/b-mobile.png')] lg:bg-[url('/assets/background-loader.png')]">
