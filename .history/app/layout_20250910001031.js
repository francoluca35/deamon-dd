...
export const metadata = {
  title: {
    default: "Deamon DD - Agencia de Desarrollo Web y Diseño Digital | Buenos Aires",
    template: "%s | Deamon DD - Desarrollo Web Profesional"
  },
  description: "Agencia líder en desarrollo web, diseño digital y marketing en Buenos Aires. Creamos sitios web profesionales, aplicaciones móviles y estrategias digitales que impulsan tu negocio. ¡Transformamos tu visión digital!",
  keywords: [
    "desarrollo web",
    "diseño web",
    "agencia digital",
