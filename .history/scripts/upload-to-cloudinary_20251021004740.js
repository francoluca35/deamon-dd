...
cloudinary.config({
  cloud_name: 'dhmswq45h', // Reemplazar con tu cloud name
  api_key: '343151578473598', // Reemplazar con tu API key
  api_secret: 'wlaFK5qhAujRSdIQ7cRMnFtF4zw' // Reemplazar con tu API secret
});
